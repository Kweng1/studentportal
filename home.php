      ...
      <div class="ftco-cover-1 overlay" style="background-image: url('images/desk.jpg')">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-5">
              <h1 class="line-bottom">Student Grading Portal</h1>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 pr-md-5 mr-auto">
            ...
            <p>This section is dedicated to students, allowing you to explore and view your student profile as well as your subjects with corresponding grades.</p>
          </div>
          <div class="col-md-6">
