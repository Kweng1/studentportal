                                ...
                                <tbody>
                                    ...
                                    function loadresult(){
                                        ...
                                        foreach ($cur as $student) {
											...
											echo '<td>'. number_format($student->FIRST, 2).'</td>';
											echo '<td>'. number_format($student->SECOND, 2).'</td>';
											echo '<td>'. number_format($student->THIRD, 2).'</td>';
											echo '<td>'. number_format($student->FOURTH, 2).'</td>';
